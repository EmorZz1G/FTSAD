...
from src.data_utils.SimAD_data_loader2 import MSLSegLoader,SMAPSegLoader,SWATSegLoader

import numpy as np

# data_path = os.path.join(dataset_dir, 'SMAP')
# train_X, test_X, test_y = SMAPSegLoader(data_path, 100, 100).load_data()
data_path = os.path.join(dataset_dir, 'SWAT')
train_X, test_X, test_y = SWATSegLoader(data_path, 100, 100).load_data()
